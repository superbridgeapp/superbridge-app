...
export const chainIcons: { [chainId: number]: string | undefined } = {
  ...
  [manta.id]: "/img/networks/manta.png",
  [inEVM.id]: "/img/networks/injective.png",
  [blast.id]: "/img/networks/blast.webp",
  [88]: "/img/networks/viction.jpg",
  [ancient8.id]: "/img/ancient8/icon.svg",
};
