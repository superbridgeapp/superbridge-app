...
export const bridgeControllerGetDeploymentsV2 = (
    deploymentsQueryDto: DeploymentsQueryDto,
 ) => {
      
      
      return customInstance<DeploymentDto[]>(
      {url: `/api/bridge/deployments`, method: 'POST',
      headers: {'Content-Type': 'application/json', },
...
export const getBridgeControllerGetDeploymentsV2MutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof bridgeControllerGetDeploymentsV2>>, TError,{data: DeploymentsQueryDto}, TContext>, }
...
const {mutation: mutationOptions} = options ?? {};
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof bridgeControllerGetDeploymentsV2>>, {data: DeploymentsQueryDto}> = (props) => {
          ...
          return  bridgeControllerGetDeploymentsV2(data,)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type BridgeControllerGetDeploymentsV2MutationError = unknown

    export const useBridgeControllerGetDeploymentsV2 = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof bridgeControllerGetDeploymentsV2>>, TError,{data: DeploymentsQueryDto}, TContext>, }
): UseMutationResult<
