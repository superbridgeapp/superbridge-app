...
export function Footer() {
  ...
  return (
    <footer className="flex flex-row justify-between px-3 md:px-6 py-3 md:py-4 fixed bottom-0 left-0 w-screen z-10  ">
      {mounted ? (
        <div
          ...
          >
            ...
            >
              <svg
                ...
                fill="none"
                viewBox="0 0 24 24"
                className="w-6 h-6 fill-zinc-900 dark:fill-zinc-50"
              >
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" side="bottom">
                {dedicatedDeployment ? (
                  <DropdownMenuItem>
                    <Link href={dedicatedDeployment.footerLink} target="_blank">
                      {t("about")}
                    </Link>
                  </DropdownMenuItem>
                ) : (
