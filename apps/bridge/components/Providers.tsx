...
function Web3Provider({ children }: { children: React.ReactNode }) {
  ...
  if (!deployments.length) {
    return (
      <div className="bg-background w-screen h-dvh overflow-hidden z-40 relative transition-colors duration-1000 tracking-tight flex justify-center transform-gpu">
        <div
          className={clsx(
