...
export const SettingsModal = ({ open, setOpen }: SettingsModalProps) => {
  ...
  const setSuperbridgeTestnets = useConfigState.useSetSuperbridgeTestnets();
        ...
        <div className="">
          ...
          <div className="px-6 py-8">
            <div className="border border-zinc-100 dark:border-zinc-800 rounded-[16px] divide-y divide-zinc-100 dark:divide-zinc-800">
              ...
              {isSuperbridge && typeof window !== "undefined" && (
                ...
                <div className="flex items-center justify-between p-4">
                  ...
                  <Switch
                    checked={superbridgeTestnets}
                    onCheckedChange={setSuperbridgeTestnets}
                  />
                </div>
              )}
