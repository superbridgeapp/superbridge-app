  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          `backdrop-blur-lg fixed left-[50%] top-[50%] z-50 w-full max-w-[340px] md:max-w-[420px] translate-x-[-50%] translate-y-[-50%] gap-4 p-0 border border-black/[0.08] dark:border-white/[0.08] shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] rounded-[21px] md:rounded-[32px] overflow-hidden bg-white dark:bg-black/80`,
          className
        )}
        {...props}
      >
