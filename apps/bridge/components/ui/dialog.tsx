...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ...
    id="overlay"
    className={cn(
      "fixed inset-0 h-dvh z-50 backdrop-blur-lg bg-white/0 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
      className
    )}
    {...props}
  />
