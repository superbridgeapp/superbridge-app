...
const BridgeCard = ({
  ...
  return (
    <article className="rounded-[24px] p-6 border border-zinc-600/5 dark:border-zinc-500/10 bg-white/50 dark:bg-zinc-500/5 transition-all hover:scale-105">
    ...
    <PageTransition>
      <div className="overflow-y-scroll p-12 md:p-24 fixed inset-0">
        <div className="pt-6 mb-6">
          <div className="flex flex-col gap-4 items-center px-8 py-12">
            <h3 className="text-6xl font-bold tracking-tighter text-center">
              Alternative Bridges
            </h3>
            <p className="text-xl font-medium tracking-tighter text-center max-w-xl">
